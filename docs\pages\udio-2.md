...
通过 YesAPI 调用 Udio 2，适合语音、音乐、音频生成和内容生产流程。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Udio 2](https://doc.yesapi.online/udio-2) |
| GitHub 分类 | 音频与音乐模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/udio-2)
...
Use Udio 2 through YesAPI for speech, music, audio generation, and content production workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Udio 2](https://doc.yesapi.online/en/udio-2) |
...
- [Open the English source docs](https://doc.yesapi.online/en/udio-2)
