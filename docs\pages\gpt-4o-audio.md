...
通过 YesAPI 调用 GPT 4o Audio，适合语音、音乐、音频生成和内容生产流程。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [GPT 4o Audio](https://doc.yesapi.online/gpt-4o-audio) |
| GitHub 分类 | 音频与音乐模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/gpt-4o-audio)
...
Use GPT 4o Audio through YesAPI for speech, music, audio generation, and content production workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [GPT 4o Audio](https://doc.yesapi.online/en/gpt-4o-audio) |
...
- [Open the English source docs](https://doc.yesapi.online/en/gpt-4o-audio)
