...
通过 YesAPI 调用 Stable Audio 2 0，适合语音、音乐、音频生成和内容生产流程。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Stable Audio 2 0](https://doc.yesapi.online/stable-audio-2-0) |
| GitHub 分类 | 音频与音乐模型 |
...
```bash
curl https://yesapi.online/v1/v1/audio/speech \
...
- [查看原始中文文档](https://doc.yesapi.online/stable-audio-2-0)
...
Use Stable Audio 2 0 through YesAPI for speech, music, audio generation, and content production workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Stable Audio 2 0](https://doc.yesapi.online/en/stable-audio-2-0) |
...
- [Open the English source docs](https://doc.yesapi.online/en/stable-audio-2-0)
