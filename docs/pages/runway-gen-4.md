...
通过 YesAPI 调用 Runway Gen 4，适合视频生成、短视频素材和多媒体工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Runway Gen 4](https://doc.yesapi.online/runway-gen-4) |
| GitHub 分类 | 视频模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/runway-gen-4)
...
Use Runway Gen 4 through YesAPI for video generation, creative assets, and multimedia workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Runway Gen 4](https://doc.yesapi.online/en/runway-gen-4) |
...
- [Open the English source docs](https://doc.yesapi.online/en/runway-gen-4)
