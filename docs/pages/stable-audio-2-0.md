...
通过 YesAPI 调用 Stable Audio 2 0，适合需要低成本接入 语音、音频与音乐模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Stable Audio 2 0](https://doc.yesapi.online/stable-audio-2-0?utm_source=github&utm_medium=docs) |
| GitHub 分类 | 语音、音频与音乐模型 |
| Base URL | `https://yesapi.online/v1` |
| 模型名称 | `stable-audio-2-0` |
...
- [查看本页官方中文来源](https://doc.yesapi.online/stable-audio-2-0?utm_source=github&utm_medium=docs)
...
Use Stable Audio 2 0 through YesAPI when you need low-cost access to speech, audio, and music models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Stable Audio 2 0](https://doc.yesapi.online/en/stable-audio-2-0?utm_source=github&utm_medium=docs) |
| GitHub category | speech, audio, and music models |
| Base URL | `https://yesapi.online/v1` |
| Model name | `stable-audio-2-0` |
...
- [Open the official English source](https://doc.yesapi.online/en/stable-audio-2-0?utm_source=github&utm_medium=docs)
