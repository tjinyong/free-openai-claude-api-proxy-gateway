...
通过 YesAPI 调用 Minimax Video 01，适合视频生成、短视频素材和多媒体工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Minimax Video 01](https://doc.yesapi.online/minimax-video-01) |
| GitHub 分类 | 视频模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/minimax-video-01)
...
Use Minimax Video 01 through YesAPI for video generation, creative assets, and multimedia workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Minimax Video 01](https://doc.yesapi.online/en/minimax-video-01) |
...
- [Open the English source docs](https://doc.yesapi.online/en/minimax-video-01)
