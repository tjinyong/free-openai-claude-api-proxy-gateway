...
通过 YesAPI 调用 Sora 2，适合视频生成、短视频素材和多媒体工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Sora 2](https://doc.yesapi.online/sora-2) |
| GitHub 分类 | 视频模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/sora-2)
...
Use Sora 2 through YesAPI for video generation, creative assets, and multimedia workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Sora 2](https://doc.yesapi.online/en/sora-2) |
...
- [Open the English source docs](https://doc.yesapi.online/en/sora-2)
