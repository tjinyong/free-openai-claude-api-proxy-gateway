...
通过 YesAPI 调用 Qwen3 Max，适合需要低成本接入 Qwen 系列模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Qwen3 Max](https://doc.yesapi.online/qwen3-max?utm_source=github&utm_medium=docs) |
| GitHub 分类 | Qwen 系列模型 |
...
- [查看本页官方中文来源](https://doc.yesapi.online/qwen3-max?utm_source=github&utm_medium=docs)
...
Use Qwen3 Max through YesAPI when you need low-cost access to Qwen family models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Qwen3 Max](https://doc.yesapi.online/en/qwen3-max?utm_source=github&utm_medium=docs) |
...
- [Open the official English source](https://doc.yesapi.online/en/qwen3-max?utm_source=github&utm_medium=docs)
