...
在兼容 OpenAI 的客户端中调用 Qwen3 Max，适合聊天、推理、代码和 Agent 工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Qwen3 Max](https://doc.yesapi.online/qwen3-max) |
| GitHub 分类 | 对话与推理模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/qwen3-max)
...
Use Qwen3 Max through YesAPI for chat, reasoning, coding, and agent workflows with an OpenAI-compatible client.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Qwen3 Max](https://doc.yesapi.online/en/qwen3-max) |
...
- [Open the English source docs](https://doc.yesapi.online/en/qwen3-max)
