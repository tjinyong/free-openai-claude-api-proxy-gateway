...
通过 YesAPI 调用 Dall E 3，适合图像生成、设计素材和自动化图片工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Dall E 3](https://doc.yesapi.online/dall-e-3) |
| GitHub 分类 | 图像模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/dall-e-3)
...
Use Dall E 3 through YesAPI for image generation, design assets, and automated image workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Dall E 3](https://doc.yesapi.online/en/dall-e-3) |
...
- [Open the English source docs](https://doc.yesapi.online/en/dall-e-3)
