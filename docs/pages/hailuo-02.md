...
通过 YesAPI 调用 Hailuo 02，适合视频生成、短视频素材和多媒体工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Hailuo 02](https://doc.yesapi.online/hailuo-02) |
| GitHub 分类 | 视频模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/hailuo-02)
...
Use Hailuo 02 through YesAPI for video generation, creative assets, and multimedia workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Hailuo 02](https://doc.yesapi.online/en/hailuo-02) |
...
- [Open the English source docs](https://doc.yesapi.online/en/hailuo-02)
