...
完成 YesAPI 基础接入、Base URL 配置和 API Key 使用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Getting Started](https://doc.yesapi.online/getting-started) |
| GitHub 分类 | 快速开始 |
...
- [查看原始中文文档](https://doc.yesapi.online/getting-started)
...
Use this page to configure the YesAPI Base URL, API key, and OpenAI-compatible endpoint.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Getting Started](https://doc.yesapi.online/en/getting-started) |
| GitHub category | Quick Start |
| Base URL | `https://yesapi.online/v1` |
...
- [Open the English source docs](https://doc.yesapi.online/en/getting-started)
