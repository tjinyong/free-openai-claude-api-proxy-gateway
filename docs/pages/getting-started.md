...
通过 YesAPI 调用 Getting Started，适合需要低成本接入 OpenAI 兼容模型与接口 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Getting Started](https://doc.yesapi.online/getting-started?utm_source=github&utm_medium=docs) |
| GitHub 分类 | OpenAI 兼容模型与接口 |
| Base URL | `https://yesapi.online/v1` |
| 模型名称 | `getting-started` |
...
- [查看本页官方中文来源](https://doc.yesapi.online/getting-started?utm_source=github&utm_medium=docs)
...
Use Getting Started through YesAPI when you need low-cost access to OpenAI-compatible models and endpoints from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Getting Started](https://doc.yesapi.online/en/getting-started?utm_source=github&utm_medium=docs) |
...
- [Open the official English source](https://doc.yesapi.online/en/getting-started?utm_source=github&utm_medium=docs)
