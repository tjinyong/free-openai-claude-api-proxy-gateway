...
通过 YesAPI 调用 Pixverse V5，适合视频生成、短视频素材和多媒体工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Pixverse V5](https://doc.yesapi.online/pixverse-v5) |
| GitHub 分类 | 视频模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/pixverse-v5)
...
Use Pixverse V5 through YesAPI for video generation, creative assets, and multimedia workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Pixverse V5](https://doc.yesapi.online/en/pixverse-v5) |
...
- [Open the English source docs](https://doc.yesapi.online/en/pixverse-v5)
