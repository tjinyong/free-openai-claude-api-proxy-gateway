...
通过 YesAPI 调用 Qwen3 Coder，适合需要低成本接入 Qwen 系列模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Qwen3 Coder](https://doc.yesapi.online/qwen3-coder?utm_source=github&utm_medium=docs) |
| GitHub 分类 | Qwen 系列模型 |
...
- [查看本页官方中文来源](https://doc.yesapi.online/qwen3-coder?utm_source=github&utm_medium=docs)
...
Use Qwen3 Coder through YesAPI when you need low-cost access to Qwen family models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Qwen3 Coder](https://doc.yesapi.online/en/qwen3-coder?utm_source=github&utm_medium=docs) |
| GitHub category | Qwen family models |
| Base URL | `https://yesapi.online/v1` |
...
- [Open the official English source](https://doc.yesapi.online/en/qwen3-coder?utm_source=github&utm_medium=docs)
