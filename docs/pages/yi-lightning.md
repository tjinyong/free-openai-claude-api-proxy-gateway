...
通过 YesAPI 调用 Yi Lightning，适合需要低成本接入 OpenAI 兼容模型与接口 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Yi Lightning](https://doc.yesapi.online/yi-lightning?utm_source=github&utm_medium=docs) |
...
- [查看本页官方中文来源](https://doc.yesapi.online/yi-lightning?utm_source=github&utm_medium=docs)
...
Use Yi Lightning through YesAPI when you need low-cost access to OpenAI-compatible models and endpoints from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Yi Lightning](https://doc.yesapi.online/en/yi-lightning?utm_source=github&utm_medium=docs) |
| GitHub category | OpenAI-compatible models and endpoints |
| Base URL | `https://yesapi.online/v1` |
| Model name | `yi-lightning` |
...
- [Open the official English source](https://doc.yesapi.online/en/yi-lightning?utm_source=github&utm_medium=docs)
