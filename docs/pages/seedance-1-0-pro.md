...
通过 YesAPI 调用 Seedance 1 0 Pro，适合需要低成本接入 视频与多模态模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Seedance 1 0 Pro](https://doc.yesapi.online/seedance-1-0-pro?utm_source=github&utm_medium=docs) |
| GitHub 分类 | 视频与多模态模型 |
| Base URL | `https://yesapi.online/v1` |
| 模型名称 | `seedance-1-0-pro` |
...
- [查看本页官方中文来源](https://doc.yesapi.online/seedance-1-0-pro?utm_source=github&utm_medium=docs)
...
Use Seedance 1 0 Pro through YesAPI when you need low-cost access to video and multimodal models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Seedance 1 0 Pro](https://doc.yesapi.online/en/seedance-1-0-pro?utm_source=github&utm_medium=docs) |
...
- [Open the official English source](https://doc.yesapi.online/en/seedance-1-0-pro?utm_source=github&utm_medium=docs)
