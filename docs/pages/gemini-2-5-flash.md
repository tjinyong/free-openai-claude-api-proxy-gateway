...
在兼容 OpenAI 的客户端中调用 Gemini 2 5 Flash，适合聊天、推理、代码和 Agent 工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Gemini 2 5 Flash](https://doc.yesapi.online/gemini-2-5-flash) |
| GitHub 分类 | 对话与推理模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/gemini-2-5-flash)
...
Use Gemini 2 5 Flash through YesAPI for chat, reasoning, coding, and agent workflows with an OpenAI-compatible client.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Gemini 2 5 Flash](https://doc.yesapi.online/en/gemini-2-5-flash) |
...
- [Open the English source docs](https://doc.yesapi.online/en/gemini-2-5-flash)
