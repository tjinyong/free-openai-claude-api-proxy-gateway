...
通过 YesAPI 调用 Qwen Audio，适合需要低成本接入 语音、音频与音乐模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Qwen Audio](https://doc.yesapi.online/qwen-audio?utm_source=github&utm_medium=docs) |
...
- [查看本页官方中文来源](https://doc.yesapi.online/qwen-audio?utm_source=github&utm_medium=docs)
...
Use Qwen Audio through YesAPI when you need low-cost access to speech, audio, and music models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Qwen Audio](https://doc.yesapi.online/en/qwen-audio?utm_source=github&utm_medium=docs) |
| GitHub category | speech, audio, and music models |
| Base URL | `https://yesapi.online/v1` |
| Model name | `qwen-audio` |
...
- [Open the official English source](https://doc.yesapi.online/en/qwen-audio?utm_source=github&utm_medium=docs)
