...
通过 YesAPI 调用 Hunyuan Image，适合图像生成、设计素材和自动化图片工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Hunyuan Image](https://doc.yesapi.online/hunyuan-image) |
| GitHub 分类 | 图像模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/hunyuan-image)
...
Use Hunyuan Image through YesAPI for image generation, design assets, and automated image workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Hunyuan Image](https://doc.yesapi.online/en/hunyuan-image) |
...
- [Open the English source docs](https://doc.yesapi.online/en/hunyuan-image)
