# Gemini Flash Image YesAPI Guide
...
通过 YesAPI 调用 Gemini Flash Image，适合需要低成本接入 图像生成与编辑模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Gemini Flash Image](https://doc.yesapi.online/gemini-flash-image?utm_source=github&utm_medium=docs) |
| GitHub 分类 | 图像生成与编辑模型 |
| Base URL | `https://yesapi.online/v1` |
| 模型名称 | `gemini-flash-image` |
...
```bash
curl https://yesapi.online/v1/images/generations \
...
- [查看本页官方中文来源](https://doc.yesapi.online/gemini-flash-image?utm_source=github&utm_medium=docs)
...
Use Gemini Flash Image through YesAPI when you need low-cost access to image generation and editing models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Gemini Flash Image](https://doc.yesapi.online/en/gemini-flash-image?utm_source=github&utm_medium=docs) |
| GitHub category | image generation and editing models |
| Base URL | `https://yesapi.online/v1` |
| Model name | `gemini-flash-image` |
...
- [Open the official English source](https://doc.yesapi.online/en/gemini-flash-image?utm_source=github&utm_medium=docs)
