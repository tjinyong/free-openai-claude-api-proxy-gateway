...
通过 YesAPI 调用 Deepseek V3 2，适合需要低成本接入 DeepSeek 系列模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Deepseek V3 2](https://doc.yesapi.online/deepseek-v3-2?utm_source=github&utm_medium=docs) |
| GitHub 分类 | DeepSeek 系列模型 |
...
- [查看本页官方中文来源](https://doc.yesapi.online/deepseek-v3-2?utm_source=github&utm_medium=docs)
...
Use Deepseek V3 2 through YesAPI when you need low-cost access to DeepSeek family models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Deepseek V3 2](https://doc.yesapi.online/en/deepseek-v3-2?utm_source=github&utm_medium=docs) |
| GitHub category | DeepSeek family models |
| Base URL | `https://yesapi.online/v1` |
...
- [Open the official English source](https://doc.yesapi.online/en/deepseek-v3-2?utm_source=github&utm_medium=docs)
