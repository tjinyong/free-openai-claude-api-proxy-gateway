...
通过 YesAPI 调用 Hunyuan Video，适合视频生成、短视频素材和多媒体工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Hunyuan Video](https://doc.yesapi.online/hunyuan-video) |
| GitHub 分类 | 视频模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/hunyuan-video)
...
Use Hunyuan Video through YesAPI for video generation, creative assets, and multimedia workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Hunyuan Video](https://doc.yesapi.online/en/hunyuan-video) |
...
- [Open the English source docs](https://doc.yesapi.online/en/hunyuan-video)
