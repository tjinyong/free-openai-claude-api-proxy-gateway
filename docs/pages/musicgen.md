...
通过 YesAPI 调用 Musicgen，适合语音、音乐、音频生成和内容生产流程。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Musicgen](https://doc.yesapi.online/musicgen) |
| GitHub 分类 | 音频与音乐模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/musicgen)
...
Use Musicgen through YesAPI for speech, music, audio generation, and content production workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Musicgen](https://doc.yesapi.online/en/musicgen) |
...
- [Open the English source docs](https://doc.yesapi.online/en/musicgen)
