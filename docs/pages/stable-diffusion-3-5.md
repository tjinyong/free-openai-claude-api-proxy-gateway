...
通过 YesAPI 调用 Stable Diffusion 3 5，适合图像生成、设计素材和自动化图片工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Stable Diffusion 3 5](https://doc.yesapi.online/stable-diffusion-3-5) |
| GitHub 分类 | 图像模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/stable-diffusion-3-5)
...
Use Stable Diffusion 3 5 through YesAPI for image generation, design assets, and automated image workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Stable Diffusion 3 5](https://doc.yesapi.online/en/stable-diffusion-3-5) |
...
- [Open the English source docs](https://doc.yesapi.online/en/stable-diffusion-3-5)
