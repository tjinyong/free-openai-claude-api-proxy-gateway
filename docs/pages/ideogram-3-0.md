...
通过 YesAPI 调用 Ideogram 3 0，适合图像生成、设计素材和自动化图片工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Ideogram 3 0](https://doc.yesapi.online/ideogram-3-0) |
| GitHub 分类 | 图像模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/ideogram-3-0)
...
Use Ideogram 3 0 through YesAPI for image generation, design assets, and automated image workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Ideogram 3 0](https://doc.yesapi.online/en/ideogram-3-0) |
...
- [Open the English source docs](https://doc.yesapi.online/en/ideogram-3-0)
