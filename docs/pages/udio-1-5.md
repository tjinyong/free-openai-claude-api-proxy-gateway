...
通过 YesAPI 调用 Udio 1 5，适合语音、音乐、音频生成和内容生产流程。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Udio 1 5](https://doc.yesapi.online/udio-1-5) |
| GitHub 分类 | 音频与音乐模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/udio-1-5)
...
Use Udio 1 5 through YesAPI for speech, music, audio generation, and content production workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Udio 1 5](https://doc.yesapi.online/en/udio-1-5) |
...
- [Open the English source docs](https://doc.yesapi.online/en/udio-1-5)
