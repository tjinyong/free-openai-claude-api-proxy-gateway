...
通过 YesAPI 调用 Deepseek R1，适合需要低成本接入 DeepSeek 系列模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Deepseek R1](https://doc.yesapi.online/deepseek-r1?utm_source=github&utm_medium=docs) |
...
- [查看本页官方中文来源](https://doc.yesapi.online/deepseek-r1?utm_source=github&utm_medium=docs)
...
Use Deepseek R1 through YesAPI when you need low-cost access to DeepSeek family models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Deepseek R1](https://doc.yesapi.online/en/deepseek-r1?utm_source=github&utm_medium=docs) |
...
- [Open the official English source](https://doc.yesapi.online/en/deepseek-r1?utm_source=github&utm_medium=docs)
