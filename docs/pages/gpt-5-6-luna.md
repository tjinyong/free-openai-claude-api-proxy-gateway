...
在兼容 OpenAI 的客户端中调用 GPT 5 6 Luna，适合聊天、推理、代码和 Agent 工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [GPT 5 6 Luna](https://doc.yesapi.online/gpt-5-6-luna) |
| GitHub 分类 | 对话与推理模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/gpt-5-6-luna)
...
Use GPT 5 6 Luna through YesAPI for chat, reasoning, coding, and agent workflows with an OpenAI-compatible client.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [GPT 5 6 Luna](https://doc.yesapi.online/en/gpt-5-6-luna) |
...
- [Open the English source docs](https://doc.yesapi.online/en/gpt-5-6-luna)
