...
通过 YesAPI 调用 Claude Sonnet 5，适合需要低成本接入 Claude 系列模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Claude Sonnet 5](https://doc.yesapi.online/claude-sonnet-5?utm_source=github&utm_medium=docs) |
...
- [查看本页官方中文来源](https://doc.yesapi.online/claude-sonnet-5?utm_source=github&utm_medium=docs)
...
Use Claude Sonnet 5 through YesAPI when you need low-cost access to Claude family models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Claude Sonnet 5](https://doc.yesapi.online/en/claude-sonnet-5?utm_source=github&utm_medium=docs) |
...
- [Open the official English source](https://doc.yesapi.online/en/claude-sonnet-5?utm_source=github&utm_medium=docs)
