...
通过 YesAPI 调用 Midjourney V6 1，适合需要低成本接入 图像生成与编辑模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Midjourney V6 1](https://doc.yesapi.online/midjourney-v6-1?utm_source=github&utm_medium=docs) |
| GitHub 分类 | 图像生成与编辑模型 |
| Base URL | `https://yesapi.online/v1` |
| 模型名称 | `midjourney-v6-1` |
...
- [查看本页官方中文来源](https://doc.yesapi.online/midjourney-v6-1?utm_source=github&utm_medium=docs)
...
Use Midjourney V6 1 through YesAPI when you need low-cost access to image generation and editing models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Midjourney V6 1](https://doc.yesapi.online/en/midjourney-v6-1?utm_source=github&utm_medium=docs) |
| GitHub category | image generation and editing models |
| Base URL | `https://yesapi.online/v1` |
| Model name | `midjourney-v6-1` |
...
- [Open the official English source](https://doc.yesapi.online/en/midjourney-v6-1?utm_source=github&utm_medium=docs)
