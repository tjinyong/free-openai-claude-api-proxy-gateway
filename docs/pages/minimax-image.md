...
通过 YesAPI 调用 Minimax Image，适合需要低成本接入 图像生成与编辑模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Minimax Image](https://doc.yesapi.online/minimax-image?utm_source=github&utm_medium=docs) |
| GitHub 分类 | 图像生成与编辑模型 |
...
- [查看本页官方中文来源](https://doc.yesapi.online/minimax-image?utm_source=github&utm_medium=docs)
...
Use Minimax Image through YesAPI when you need low-cost access to image generation and editing models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Minimax Image](https://doc.yesapi.online/en/minimax-image?utm_source=github&utm_medium=docs) |
| GitHub category | image generation and editing models |
| Base URL | `https://yesapi.online/v1` |
| Model name | `minimax-image` |
...
- [Open the official English source](https://doc.yesapi.online/en/minimax-image?utm_source=github&utm_medium=docs)
