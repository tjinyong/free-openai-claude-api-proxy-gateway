...
通过 YesAPI 调用 Vidu Q1，适合视频生成、短视频素材和多媒体工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Vidu Q1](https://doc.yesapi.online/vidu-q1) |
| GitHub 分类 | 视频模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/vidu-q1)
...
Use Vidu Q1 through YesAPI for video generation, creative assets, and multimedia workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Vidu Q1](https://doc.yesapi.online/en/vidu-q1) |
...
- [Open the English source docs](https://doc.yesapi.online/en/vidu-q1)
