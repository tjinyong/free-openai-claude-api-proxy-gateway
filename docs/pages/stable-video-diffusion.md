# Stable Video Diffusion YesAPI Guide
...
通过 YesAPI 调用 Stable Video Diffusion，适合需要低成本接入 视频与多模态模型 的开发者、AI 编程工具和自动化应用。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Stable Video Diffusion](https://doc.yesapi.online/stable-video-diffusion?utm_source=github&utm_medium=docs) |
| GitHub 分类 | 视频与多模态模型 |
| Base URL | `https://yesapi.online/v1` |
| 模型名称 | `stable-video-diffusion` |
...
- [查看本页官方中文来源](https://doc.yesapi.online/stable-video-diffusion?utm_source=github&utm_medium=docs)
...
Use Stable Video Diffusion through YesAPI when you need low-cost access to video and multimodal models from coding tools, API apps, or automation workflows.

### Basic Information

| Item | Value |
| :--- | :--- |
| Official docs | [Stable Video Diffusion](https://doc.yesapi.online/en/stable-video-diffusion?utm_source=github&utm_medium=docs) |
| GitHub category | video and multimodal models |
| Base URL | `https://yesapi.online/v1` |
...
- [Open the official English source](https://doc.yesapi.online/en/stable-video-diffusion?utm_source=github&utm_medium=docs)
