...
通过 YesAPI 调用 Stable Video Diffusion，适合视频生成、短视频素材和多媒体工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Stable Video Diffusion](https://doc.yesapi.online/stable-video-diffusion) |
| GitHub 分类 | 视频模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/stable-video-diffusion)
...
Use Stable Video Diffusion through YesAPI for video generation, creative assets, and multimedia workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Stable Video Diffusion](https://doc.yesapi.online/en/stable-video-diffusion) |
...
- [Open the English source docs](https://doc.yesapi.online/en/stable-video-diffusion)
