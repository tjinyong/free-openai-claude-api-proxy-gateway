...
通过 YesAPI 调用 GPT Image 1 Mini，适合图像生成、设计素材和自动化图片工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [GPT Image 1 Mini](https://doc.yesapi.online/gpt-image-1-mini) |
| GitHub 分类 | 图像模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/gpt-image-1-mini)
...
Use GPT Image 1 Mini through YesAPI for image generation, design assets, and automated image workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [GPT Image 1 Mini](https://doc.yesapi.online/en/gpt-image-1-mini) |
...
- [Open the English source docs](https://doc.yesapi.online/en/gpt-image-1-mini)
