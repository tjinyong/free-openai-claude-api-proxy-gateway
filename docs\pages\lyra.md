...
通过 YesAPI 调用 Lyra，适合语音、音乐、音频生成和内容生产流程。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Lyra](https://doc.yesapi.online/lyra) |
| GitHub 分类 | 音频与音乐模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/lyra)
...
Use Lyra through YesAPI for speech, music, audio generation, and content production workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Lyra](https://doc.yesapi.online/en/lyra) |
...
- [Open the English source docs](https://doc.yesapi.online/en/lyra)
