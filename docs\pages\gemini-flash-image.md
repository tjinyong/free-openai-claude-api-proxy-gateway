...
通过 YesAPI 调用 Gemini Flash Image，适合图像生成、设计素材和自动化图片工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Gemini Flash Image](https://doc.yesapi.online/gemini-flash-image) |
| GitHub 分类 | 图像模型 |
...
```bash
curl https://yesapi.online/v1/v1/images/generations \
...
- [查看原始中文文档](https://doc.yesapi.online/gemini-flash-image)
...
Use Gemini Flash Image through YesAPI for image generation, design assets, and automated image workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Gemini Flash Image](https://doc.yesapi.online/en/gemini-flash-image) |
| GitHub category | Image Models |
| Base URL | `https://yesapi.online/v1` |
...
- [Open the English source docs](https://doc.yesapi.online/en/gemini-flash-image)
