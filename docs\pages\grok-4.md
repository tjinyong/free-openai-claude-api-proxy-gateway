...
在兼容 OpenAI 的客户端中调用 Grok 4，适合聊天、推理、代码和 Agent 工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Grok 4](https://doc.yesapi.online/grok-4) |
| GitHub 分类 | 对话与推理模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/grok-4)
...
Use Grok 4 through YesAPI for chat, reasoning, coding, and agent workflows with an OpenAI-compatible client.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Grok 4](https://doc.yesapi.online/en/grok-4) |
...
- [Open the English source docs](https://doc.yesapi.online/en/grok-4)
