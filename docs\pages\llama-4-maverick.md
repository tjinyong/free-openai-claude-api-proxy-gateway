...
在兼容 OpenAI 的客户端中调用 Llama 4 Maverick，适合聊天、推理、代码和 Agent 工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Llama 4 Maverick](https://doc.yesapi.online/llama-4-maverick) |
| GitHub 分类 | 对话与推理模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/llama-4-maverick)
...
Use Llama 4 Maverick through YesAPI for chat, reasoning, coding, and agent workflows with an OpenAI-compatible client.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Llama 4 Maverick](https://doc.yesapi.online/en/llama-4-maverick) |
...
- [Open the English source docs](https://doc.yesapi.online/en/llama-4-maverick)
