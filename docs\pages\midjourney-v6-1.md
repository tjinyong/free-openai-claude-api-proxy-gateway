...
通过 YesAPI 调用 Midjourney V6 1，适合图像生成、设计素材和自动化图片工作流。

### 基本信息

| 项目 | 配置 |
| :--- | :--- |
| 官方文档 | [Midjourney V6 1](https://doc.yesapi.online/midjourney-v6-1) |
| GitHub 分类 | 图像模型 |
...
- [查看原始中文文档](https://doc.yesapi.online/midjourney-v6-1)
...
Use Midjourney V6 1 through YesAPI for image generation, design assets, and automated image workflows.

### Basic information

| Item | Value |
| :--- | :--- |
| Official docs | [Midjourney V6 1](https://doc.yesapi.online/en/midjourney-v6-1) |
...
- [Open the English source docs](https://doc.yesapi.online/en/midjourney-v6-1)
